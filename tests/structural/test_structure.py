...
class TestStructure(StructuralTests):
    ...
    def test_plugin_name(self, plugin_json):
        assert plugin_json["name"] == "intermonk"

    def test_plugin_json_valid(self, project_root, plugin_json):
        """plugin.json has required fields (intermonk also requires 'license')."""
    ...
    def test_required_root_files(self, project_root):
        """All required root-level files exist (intermonk also requires README.md, AGENTS.md)."""
        required = [
            "README.md", "CLAUDE.md", "AGENTS.md",
            "PHILOSOPHY.md", "LICENSE", ".gitignore",
        ]
